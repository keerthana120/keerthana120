...
public class Tictacktoegame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Tictacktoegame window = new Tictacktoegame();
	...
	private void winningGame() {
		//for player x
		if(b1==1 && b2 ==1 && b3==1) {
			JOptionPane.showMessageDialog(frame, "player x wins","tictactoe",JOptionPane.INFORMATION_MESSAGE);
			xCount1++;
		...
		//for player o only
			...
			JOptionPane.showMessageDialog(frame, "player o wins","tictactoe",JOptionPane.INFORMATION_MESSAGE);
			OCount1++;
			...
			JOptionPane.showMessageDialog(frame, "No one  wins","tictactoe",JOptionPane.INFORMATION_MESSAGE);
	...
	private void initialize() {
		...
		xCount.setFont(new Font("Tahoma", Font.BOLD, 50));
		...
		OCount.setFont(new Font("Tahoma", Font.BOLD, 50));
		...
		panel_5.add(btnReset, BorderLayout.CENTER);
